...
In order to use the matrix functions in AdapteR package, it is necessary for the input table to be in a deep format. The deep format for organization of matrix data is explained as follows.
...
In the current version of the package AdapteR, there are two limitations for matrix functions and they are listed as below.
