...
In order to use the Data Mining functions in AdapteR package, it is necessary for the input table to be in a wide format. The wide format for organization of data is illustrated in Table 1.
