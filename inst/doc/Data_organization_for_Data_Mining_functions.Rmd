...
In order to use the Data Mining functions in RLytix package, it is necessary for the input table to be in a wide format. The wide format for organization of data is illustrated in Table 1.
