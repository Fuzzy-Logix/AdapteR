...
#' @param primary_key name of primary key column of the table mapped to FLTable
...
#' @param var.equal (only in case of two-sample test) a logical variable indicating whether to treat the two variances as being equal
...
#'
#' @return returns the value of t-test statistic and probability (P-Value) of test statistic
#'
