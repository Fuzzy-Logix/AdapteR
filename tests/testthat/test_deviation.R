...
Renv$matrix1 = matrix(sample(1:1000,60,replace = TRUE), nrow = 20, ncol = 30, byrow = TRUE)
Renv$dataframe1 = data.frame(sample(1:1000,10,replace = TRUE), sample(1:1000,10,replace = TRUE))
FLenv = as.FL(Renv)
