...
#Test Failed(results same, conversion problem)
# Not able to compare object of class dist with object of class matrix.
#After adding as.matrix(object) in FLexpect_equal with signature ANY and FLMatrix, formed matrix were of different dimensions.
#Asana Ticket = https://app.asana.com/0/143316600934101/145657030318451
test_that("Check for matrix distance with different arguments and Euclidean method",{
...
test_that("Check for matrix distance with manhattan method",{
