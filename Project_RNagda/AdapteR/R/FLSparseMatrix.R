...
`+.FLSparseMatrix` <- function(flmatobj1, flmatobj2)
{
	...
	sqlQuery(flmatobj1@odbc_connection, paste0(" insert into ",flmatobj1@db_name,".",flmatobj1@matrix_table,
			" select distinct ",matrix_id_value,",a.",flmatobj1@row_id_colname,",a.",flmatobj1@col_id_colname,",a.",
			flmatobj1@cell_val_colname," from ",flmatobj1@db_name,".",flmatobj1@matrix_table," a, ",flmatobj2@db_name,".",flmatobj2@matrix_table,
			" b where a.",flmatobj1@matrix_id_colname,"=",flmatobj1@matrix_id_value," and b.",flmatobj2@matrix_id_colname,"=",flmatobj2@matrix_id_value,
			" and a.",flmatobj1@row_id_colname," != b.",flmatobj2@row_id_colname," and a.",flmatobj1@col_id_colname,"!=b.",flmatobj2@col_id_colname,
            " except ",
            "select ",matrix_id_value,",a.",flmatobj1@row_id_colname,",a.",flmatobj1@col_id_colname,",a.",flmatobj1@cell_val_colname," from ",
            ...
            " union all ",
            "select distinct ",matrix_id_value,",b.",flmatobj2@row_id_colname,",b.",flmatobj2@col_id_colname,",b.",flmatobj2@cell_val_colname," from ",
            flmatobj1@db_name,".",flmatobj1@matrix_table," a, ",flmatobj2@db_name,".",flmatobj2@matrix_table," b where a.",flmatobj1@matrix_id_colname,"=",
            flmatobj1@matrix_id_value," and b.",flmatobj2@matrix_id_colname,"=",flmatobj2@matrix_id_value," and a.",flmatobj1@row_id_colname," != b.",
            flmatobj2@row_id_colname," and a.",flmatobj1@col_id_colname,"!=b.",flmatobj2@col_id_colname,
            " except ",
            "select ",matrix_id_value,",b.",flmatobj2@row_id_colname,",b.",flmatobj2@col_id_colname,",b.",flmatobj2@cell_val_colname," from ",
            flmatobj1@db_name,".",flmatobj1@matrix_table," a, ",flmatobj2@db_name,".",flmatobj2@matrix_table," b where a.",flmatobj1@matrix_id_colname,"=",
            flmatobj1@matrix_id_value," and b.",flmatobj2@matrix_id_colname,"=",flmatobj2@matrix_id_value," and a.",flmatobj1@row_id_colname," = b.",
            flmatobj2@row_id_colname," and a.",flmatobj1@col_id_colname,"=b.",flmatobj2@col_id_colname,
            " union all ",
            "select ",matrix_id_value,",a.",flmatobj1@row_id_colname,",a.",flmatobj1@col_id_colname,",a.",flmatobj1@cell_val_colname,"+b.",
            flmatobj2@cell_val_colname," from ",flmatobj1@db_name,".",flmatobj1@matrix_table," a, ",flmatobj2@db_name,".",flmatobj2@matrix_table," b where a.",
            flmatobj1@matrix_id_colname,"=",flmatobj1@matrix_id_value," and b.",flmatobj2@matrix_id_colname,"=",flmatobj2@matrix_id_value," and a.",
            flmatobj1@row_id_colname," = b.",flmatobj2@row_id_colname," and a.",flmatobj1@col_id_colname," =b.",flmatobj2@col_id_colname))	
	...
	sqlQuery(flmatobj2@odbc_connection, paste0(" insert into ",flmatobj2@db_name,".",flmatobj2@matrix_table,
			" select distinct ",matrix_id_value,",b.",flmatobj2@row_id_colname,",b.",flmatobj2@col_id_colname,",b.",
			flmatobj2@cell_val_colname," from ",flmatobj1@db_name,".",flmatobj1@matrix_table," a, ",flmatobj2@db_name,".",flmatobj2@matrix_table,
			" b where a.",flmatobj1@matrix_id_colname,"=",flmatobj1@matrix_id_value," and b.",flmatobj2@matrix_id_colname,"=",flmatobj2@matrix_id_value,
			" and a.",flmatobj1@row_id_colname," != b.",flmatobj2@row_id_colname," and a.",flmatobj1@col_id_colname,"!=b.",flmatobj2@col_id_colname,
            " except ",
            "select ",matrix_id_value,",b.",flmatobj2@row_id_colname,",b.",flmatobj2@col_id_colname,",b.",flmatobj2@cell_val_colname," from ",
            ...
            flmatobj2@row_id_colname," and a.",flmatobj1@col_id_colname,"=b.",flmatobj2@col_id_colname,
            " union all ",
			"select ",matrix_id_value,",b.",flmatobj2@row_id_colname,",b.",flmatobj2@col_id_colname,",b.",flmatobj2@cell_val_colname,"+a.",
            flmatobj1@cell_val_colname," from ",flmatobj1@db_name,".",flmatobj1@matrix_table," a, ",flmatobj2@db_name,".",flmatobj2@matrix_table," b where a.",
            flmatobj1@matrix_id_colname,"=",flmatobj1@matrix_id_value," and b.",flmatobj2@matrix_id_colname,"=",flmatobj2@matrix_id_value," and a.",
            flmatobj1@row_id_colname," = b.",flmatobj2@row_id_colname," and a.",flmatobj1@col_id_colname," =b.",flmatobj2@col_id_colname))
