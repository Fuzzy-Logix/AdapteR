...
(Before running the demo for the first time, also run the scripts in [[id:A7CCAA11-1DCD-482D-8744-88631588B3AF][Optional packages]]).
...
To start a demo, first set your connection info with ODBC ([[id:EA123B7F-CC54-405A-86E4-740A788FC239][If you use JDBC, see below how to set your connection info with JDBC]])
#+BEGIN_SRC R :session r_fl :results output :exports both
