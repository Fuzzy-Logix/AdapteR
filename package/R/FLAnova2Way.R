...
#' @param variable column name for the first categorical variable
#' @param variable column name for the second categorical variable
...
#' \item{Pr(>F)}{P-Value}
#' There are two rows in the result, one for each of the variable terms in the
...
#' \dontrun{
#'
#' FLAnova1Way(table = tbl, response = "MPG", variable1 = "CarName", variable2 = "Origin") 
#' # Select American brands only
#' FLAnova1Way(table = tbl, response = "MPG", variable1 = "CarName", variable2 = "Origin", where_clause = "CarName IN ('Chrysler', 'Dodge', 'Ford')" )
#'
#' }
